...
> This repo is abandoned, check out the next iteration of this project which uses [a webpack plugin](https://github.com/dreamonkey/responsive-image-plugin) instad of a loader and solves many performance issues.
